// api/chat.js — RHF ZERO Chat Handler (updated: Firebase Memory integration)
...
export default async function handler(req, res) {
  ...
  // ── SIMPAN KE FIREBASE (jika uid & chatId tersedia) ──
  if (uid && chatId) {
    try {
      // Pastikan chat room ada (createChat bersifat idempoten pakai PATCH)
      ...
      // Jangan gagalkan response hanya karena memory error
